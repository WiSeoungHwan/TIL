...
class UserProfileHeader: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        editProfileButton.anchor(top: postsLabel.bottomAnchor, left: postsLabel.leadingAnchor, bottom: nil, right: trailingAnchor, paddingTop: 4, paddingLeft: 8, paddingBottom: 0, paddingRight: 12, width: 0, height: 30)
